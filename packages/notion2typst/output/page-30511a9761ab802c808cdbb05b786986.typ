...
També podem tenir checklists (to-do list)\
- [X] Comprar llet (fet)
- [ ] Escombrar l’habitació (pendent de fer)

A continuació una subpàgina\
Example checklists, columnes i toggles
#link("https://notion.so/30611a97-61ab-80fa-9156-c1501e88d148")[📄 Example checklists, columnes i toggles] // Child page
També podem tenir mentions de persones com \@Martí Pardo o de dates com 2026-02-14 o de subpàgines a les que tenim accés com _Example checklists, columnes i toggles_ o de subpàgines a les que no tenim accés com _Untitled_.\
...
Aii ens estàvem deixant els toggle headings\
// Toggle block
#toggle(heading: 3)[Això és un toggle heading de nivell 3
][I a dins hi pot haver tot tipus de blocks.\
]// Toggle block
#toggle(heading: 2)[Això és un toggle heading de nivell 3
][I a dins hi pot haver tot tipus de blocks.\
...
```
Ah i podem posar columnes\
#columns(2, gutter: 2em)[ 
I a cada columna hi pot haver qualsevol tipus de bloc\
=== Com ara un heading
#colbreak()
#quote[
Podem començar la columna amb una cita\
]
I després posar text, etc.\
]
També es poden posar també taules simples\
#table(
  columns: (1fr, 1fr, 1fr),
...
#link("https://notion.so/30511a97-61ab-802c-808c-dbb05b786986")[📄 File]
...
#link("https://notion.so/30511a97-61ab-802c-808c-dbb05b786986")[🎥 Video]
...
#link("https://notion.so/30511a97-61ab-802c-808c-dbb05b786986")[📕 PDF Document]
